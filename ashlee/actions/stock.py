...
class Stock(Action):
    ...
    def after_loaded(self):
        Stock.PIXABAI_API = Stock.PIXABAI_API.replace('%KEY%', self.tgb.api_keys['pixabay_apikey'])
    ...
    def call(self, message: Message):
        ...
        data = json.loads(requests.get(self.PIXABAI_API.format(quote(text))).content.decode('utf-8'))
        if data['totalHits'] > 0:
