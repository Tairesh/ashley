...
class Forget(Action):
    ...
    def call(self, message: Message):
        ...
        trigrams = pepe.remove_all_trigrams(
            self.tgb.redis, message.reply_to_message.text
        )
        text = "These keys have been successfully forgotten: " + ", ".join(
            ["->".join(t) for t in trigrams]
        )
